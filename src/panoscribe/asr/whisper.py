...
from panoscribe.device import require_cuda_for_asr  # noqa: E402 (must follow DLL registration)
from panoscribe.output import TranscriptSegment  # noqa: E402 (must follow DLL registration)
...
class WhisperTranscriber:
    ...
    def __init__(self, config: PanoScribeConfig) -> None:
        self._config = config
